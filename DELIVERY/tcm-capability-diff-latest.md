...
- 生成：2026-09-07 19:45 ｜ 差集指纹 `c12b4e31946e45d8`
- tcm 侧 HEAD：`4f7475e DELIVERY：知识蒸馏与活化诊断报告 2026-09-07（库存/覆盖/活化/问题清单，无P0P1）`
- 结论：**⚠ 有待吸收增量**

## L1 API 路由差集（tcm 有 · medical-stack 无）：1 条
- `post /api/tcm/kb/diff-feedback`
...
| `/api/tcm/kb/formula-recall` | `b1cca84d4f18f7e6` | `ac23b246775f610a` | 🔴 漂移 DRIFT |
...
| 资产 | tcm 哈希 | ms 哈希 | 状态 |
|---|---|---|---|
| `formula-symptom-index.json` | `571cd169b046` | `571cd169b046` | ✅ 一致 |
