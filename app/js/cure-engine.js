...
function _getQimenMenCure(analyzeData) {
  var menCureDB = {
    '开门': { nature: '吉门', desc: '开门主通达开拓', cure: '宜向西北方行事，佩戴白水晶增强开门之吉', item: '白水晶、金属摆件' },
    '休门': { nature: '吉门', desc: '休门主安养休息', cure: '宜向正北方休养，佩戴海蓝宝增强休门之吉', item: '海蓝宝、蓝色摆件' },
    '生门': { nature: '吉门', desc: '生门主生发财运', cure: '宜向东北方求财，佩戴黄水晶增强生门之吉', item: '黄水晶、聚宝盆' },
    '伤门': { nature: '凶门', desc: '伤门主伤害争斗', cure: '1.佩戴黑曜石化解伤门之煞；2.避免东方行事；3.家中正东放黑曜石麒麟', item: '黑曜石麒麟、黑曜石手串' },
    '杜门': { nature: '凶门', desc: '杜门主闭塞不通', cure: '1.佩戴绿幽灵化解杜门之塞；2.东南方放绿色植物疏通；3.多与人沟通，避免封闭', item: '绿幽灵水晶、绿色盆栽' },
    '景门': { nature: '平门', desc: '景门主文书信息', cure: '宜在南方放红色花瓶增强文书运，考试面试可向南方', item: '红色花瓶、红玛瑙' },
...
function _getQimenXingCure(analyzeData) {
  var xingCureDB = {
    '天蓬': { nature: '凶星', desc: '天蓬主盗贼水灾', cure: '佩戴黑曜石化解，家中正北放黑曜石玄武' },
    '天芮': { nature: '凶星', desc: '天芮主疾病缠身', cure: '佩戴和田玉化解，家中西南放铜葫芦祛病' },
    '天冲': { nature: '凶星', desc: '天冲主冲动伤损', cure: '佩戴茶晶化解，家中正东放黑曜石麒麟' },
    '天辅': { nature: '吉星', desc: '天辅主文教辅佐', cure: '佩戴文昌石增强，东南方放文昌塔' },
    '天禽': { nature: '吉星', desc: '天禽主稳重权威', cure: '佩戴黄水晶增强，中央放黄水晶球' },
    '天心': { nature: '吉星', desc: '天心主医疗延寿', cure: '佩戴白水晶增强，西北方放白色水晶簇' },
    '天柱': { nature: '凶星', desc: '天柱主破败惊恐', cure: '佩戴蓝水晶化解，正西方放蓝色摆件' },
...
function _getQimenShenCure(analyzeData) {
  var shenCureDB = {
    '值符': { desc: '值符主贵人统领', cure: '佩戴黄水晶增强贵人运，西北方放铜龙' },
    '腾蛇': { desc: '腾蛇主虚惊怪异', cure: '佩戴黑曜石化解虚惊，家中放黑曜石葫芦' },
    '太阴': { desc: '太阴主暗助荫庇', cure: '佩戴月光石增强阴助，西方放白色花瓶' },
    '六合': { desc: '六合主婚姻和合', cure: '佩戴粉晶增强姻缘，东南方放粉色水晶球' },
    '白虎': { desc: '白虎主凶险血光', cure: '佩戴黑曜石或铜麒麟化解白虎之煞，西方放铜麒麟' },
    '玄武': { desc: '玄武主盗贼暗昧', cure: '佩戴黑曜石化解暗昧，正北放黑曜石玄武' },
...
function _getQimenFuFanCure(panData, analyzeData) {
  var html = '<div style="background:rgba(255,255,255,0.02);padding:14px;border-radius:8px;border:1px solid rgba(201,168,76,0.1)">';
  html += '<p style="font-size:12px;line-height:2"><strong>伏吟化解：</strong>伏吟主呻吟忧郁，凡事受阻。化解之法：1.佩戴开光白水晶疏通气场；2.家中中央放铜铃，每日摇晃三下破除伏吟之气；3.多外出活动，避免久坐一处。</p>';
  html += '<p style="font-size:12px;line-height:2;margin-top:10px"><strong>反吟化解：</strong>反吟主反复颠倒，事多波折。化解之法：1.佩戴黑曜石稳定气场；2.家中正北放黑曜石麒麟一对；3.做事反复确认，避免冲动决策；4.重要事项择吉日吉时进行。</p>';
  html += '<p style="font-size:11px;opacity:.4;margin-top:8px">《奇门遁甲秘笈大全》云：「伏吟宜静不宜动，反吟宜缓不宜急。」</p>';
  html += '</div>';
  return html;
}
  html += '<p style="font-size:11px;opacity:.4;margin-top:8px">流年化解需每年更新，建议缘主每年初重新排盘调整。化煞之道，贵在及时。</p>';
