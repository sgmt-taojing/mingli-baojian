...
var FESTIVAL_2026 = {
  ...
  '06-11': { name: '城隍诞', kind: 'dao', theme: '城隍护佑',
    wish: '城隍圣诞，护佑一方。值此佳日，恭祝您居处平安，出入顺遂，逢凶化吉。',
    img: '城隍庙飞檐翘角，红烛高照，百姓祈福，写意水墨' },
  '06-20': { name: '关帝诞', kind: 'ru', theme: '武圣忠义',
