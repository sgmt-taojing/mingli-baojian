...
> 最后更新: 2026-08-20 16:11 CST（cron 监控第十七次复核：与 15:11/14:11/13:11/12:11/11:11/09:11/06:11/05:11/03:12/02:11/01:13/00:11/22:11/21:00/17:11 等前 16 次复核完全一致——v9.2=3/488=0.6%（v9.2-full488.log 10:04 API=8962）/16/488=3.3%（v92-full-full488.log 09:30）<< v9.0=263/488=53.9%，修真失败结论不变，生产保持 v9.0，#5 已完结状态不变；崩模型根因=fused-as-base 续训陷阱（lr 5e-6+iter 300+base 已 fused）+ loss 正常≠模型可用 + 483/488 答案空串（`模型=?`）；8960=v9.0-7b ✅ PID 28061 监听（curl /v1/models 200 返 mingli-sft-v9.0-7b）；8962/8964 评估端口无监听已停；eval-baziqa=0 进程干净；/tmp/baziqa-v92-eval.log 不存在；源 fused-archive(空)/v9.1-7b(不存在) 幂等保护跳过；归档目标 41G 已稳；mlx-models-archive/v9.1-7b 已存无需重归档；已记 memory/2026-08-20.md 16:11）
> 最后更新: 2026-08-20 15:11 CST（cron 监控第十六次复核：与 14:11/13:11/12:11/11:11/09:11/06:11/05:11/03:12/02:11/01:13/00:11/22:11/21:00/17:11 等前 15 次复核完全一致——v9.2=3/488=0.6%（v9.2-full488.log 10:04 API=8962）/16/488=3.3%（v92-full-full488.log 09:30）<< v9.0=263/488=53.9%，修真失败结论不变，生产保持 v9.0，#5 已完结状态不变；崩模型根因=fused-as-base 续训陷阱（lr 5e-6+iter 300+base 已 fused）+ loss 正常≠模型可用 + 483/488 答案空串（`模型=?`）；8960=v9.0-7b ✅ PID 28061 监听（curl /v1/models 200 返 mingli-sft-v9.0-7b）；8962/8964 评估端口无监听已停；eval-baziqa=0 进程干净；/tmp/baziqa-v92-eval.log 不存在；源 fused-archive(空)/v9.1-7b(不存在) 幂等保护跳过；归档目标 41G 已稳；已记 memory/2026-08-20.md）
> 最后更新: 2026-08-20 13:11 CST（cron 监控第十四次复核：与 12:11/11:11/09:11/05:11/06:11/03:12/02:11/00:11/22:11/21:00/17:11 等前 13 次复核完全一致——v9.2=3/488=0.6%（v9.2-full488.log 10:04 API=8962）/16/488=3.3%（v92-full-full488.log 09:30）<< v9.0=263/488=53.9%，修真失败结论不变，生产保持 v9.0，#5 已完结状态不变；崩模型根因=fused-as-base 续训陷阱（lr 5e-6+iter 300+base 已 fused）+ loss 正常≠模型可用 + 483/488 答案空串（`模型=?`）；8960=v9.0-7b ✅ PID 28061 监听（mlx-inference-server.py 8/19 12:09 起持续稳定，curl /v1/models 200 ✅ 返 mingli-sft-v9.0-7b）；8962/8964 评估端口无监听已停；eval-baziqa=0 进程干净；/tmp/baziqa-v92-eval.log 不存在；源 fused-archive(空)/v9.1-7b(不存在) 幂等保护跳过；归档目标 41G 已稳；已记 memory/2026-08-20.md）（cron 监控第十三次复核：与 11:11/09:11/05:11/06:11/03:12/02:11/00:11/22:11/21:00/17:11 等前 12 次复核完全一致——v9.2=3/488=0.6%（v9.2-full488.log 10:04 API=8962）/16/488=3.3%（v92-full-full488.log 09:30）<< v9.0=263/488=53.9%，修真失败结论不变，生产保持 v9.0，#5 已完结；崩模型根因=fused-as-base 续训陷阱（lr 5e-6+iter 300+base 已 fused）+ loss 正常≠模型可用 + 483/488 答案空串（`模型=?`）；8960=v9.0-7b ✅ PID 28061 监听；8962/8964 评估端口无监听已停；eval-baziqa=0 进程干净；/tmp/baziqa-v92-eval.log 不存在；源 fused-archive(空)/v9.1-7b(不存在) 幂等保护跳过；归档目标 41G 已稳；已记 memory/2026-08-20.md）（cron 监控第十二次复核：与 09:11/05:11/06:11/03:12/02:11/00:11/22:11/21:00 等前 11 次复核完全一致——v9.2=3/488=0.6%（v9.2-full488.log 10:04 API=8962）/16/488=3.3%（v92-full-full488.log 09:30）<< v9.0=263/488=53.9%，修真失败结论不变，生产保持 v9.0，#5 已完结；崩模型根因=fused-as-base 续训陷阱（lr 5e-6+iter 300+base 已 fused）+ loss 正常≠模型可用；8960=v9.0-7b ✅ PID 28061 监听；8962/8964 评估端口无监听已停；eval-baziqa=0 进程干净；/tmp/baziqa-v92-eval.log 不存在；源 fused-archive(空)/v9.1-7b(不存在) 幂等保护跳过；已记 memory/2026-08-20.md）（cron 监控第十次复核：v9.2=3/488=0.6%（v9.2-full488.log）/16/488=3.3%（v92-full-full488.log）<< v9.0=263/488=53.9%，结论不变：生产保持 v9.0，#5 已完结；崩模型根因=adapter_config max_seq_length 768 不匹配 v9.0/v9.1 的 1024 + iters=50 中断 + seed=0；459/488 答案空串（`模型=?`）；8960=v9.0-7b ✅ PID 28061 监听；8962 评估服务无监听已停；源 fused-archive(空)/v9.1-7b(不存在) 幂等保护跳过；/tmp/baziqa-v92-eval.log 不存在→eval-baziqa=0 进程干净；已记 memory/2026-08-19.md）
