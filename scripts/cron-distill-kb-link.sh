...
python3 "/Users/tom/.openclaw-autoclaw/workspace/projects/mingli-baojian/scripts/distill-backlog-ingest.py" --days 2 >> "$LOG_FILE" 2>&1 || echo "[$(date '+%F %T')] [R804] 补账失败(非阻塞)" >> "$LOG_FILE"
python3 "/Users/tom/.openclaw-autoclaw/workspace/projects/mingli-baojian/scripts/kb-sync-guard.py" --sync 48 >> "$LOG_FILE" 2>&1 || true
