...
WORDS = {'南无':'nā mó','般若':'bō rě','涅槃':'niè pán','菩提':'pú tí',
         ...
         '捭阖':'bǎi hé','翕张':'xī zhāng','窾理':'kuǎn lǐ','抵巇':'dǐ xī','罅隙':'xià xì','飞箝':'fēi qián','忤合':'wǔ hé','损兑':'sǔn duì','转圆':'zhuǎn yuán','分威':'fēn wēi','散势':'sàn shì','养志':'yǎng zhì','盛神':'shèng shén','实意':'shí yì'}
