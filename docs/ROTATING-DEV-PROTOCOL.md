...
|---|---|---|---|---|---|
| WO-001 | AutoClaw | 养生域KB起步14条+STALE快照清欠+接管基线 | Y | 0 | 逾期默认通过（R802 登记：交付 09-17 10:35，reviewer 超 24h 未签；后补抽验条款保留） |
| WO-002 | Kimi | v9.2 BaziQA 重评定案+四路大师蒸馏恢复 | — | — | **Kimi 已领单 2026-09-17 11:06**（48h 时限至 09-19 11:06，逾期自动轮转） |
